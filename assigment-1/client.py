...
if __name__ == '__main__':
    ...
    integer = int(input("[CLIENT]Enter a positive integer on the terminal : "))
    ...
    print(f'[CLIENT]Modified integer:{data[data["key"]]}')
    ...
    result = json.loads(client.recv(2048).decode(FORMAT)) #obtains the result as a dictionary consisting of the key and the array of the prime factorization of the modified integer

    print(f"[CLIENT]The result is {result[result['key']]}")
